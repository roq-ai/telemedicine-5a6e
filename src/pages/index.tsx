  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless healthcare with telemedicine - Bridging the gap between doctors and patients through innovative software solutions."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless healthcare with telemedicine - Bridging the gap between doctors and patients through innovative software solutions.`}
            </Text>
            <Box
