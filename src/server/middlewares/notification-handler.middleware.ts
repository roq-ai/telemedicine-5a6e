...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'profile.update': {
    roles: ['administrator', 'doctor', 'technical-support', 'nurse'],
    key: 'customer-updated-profile',
    tenantPath: ['organization', 'user', 'profile'],
    userPath: [],
  },
  'appointment.create': {
    roles: ['doctor', 'nurse'],
    key: 'doctor-created-appointment',
    tenantPath: ['organization', 'user', 'appointment'],
    userPath: [],
  },
  'medical_record.update': {
    roles: ['doctor', 'nurse'],
    key: 'nurse-updated-medical-record',
    tenantPath: ['organization', 'user', 'medical_record'],
    userPath: [],
  },
};
